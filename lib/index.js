...
module.exports = projectRoot => {
  ...
  const extended = (process.env.HUGO_BIN_BUILD_TAGS || process.env.npm_config_hugo_bin_build_tags || process.env.npm_package_config_hugo_bin_build_tags || config.buildTags) === 'extended';
